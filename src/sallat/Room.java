...
class Room {
	...
	private Room() {	// a private constructor
		...
		GameWindow window = new GameWindow(600,600,"sallat.Snake alpha ".concat(VERSION));
	...
	private class Listener extends KeyAdapter { // !!! sallat.Matrix should not have control over the snake
